...
@section('title')
    Светопропускающие конструкции - Летние кафе
@stop
...
@section('slides')
    <li>
        {{ HTML::image('images/viveski/райффайзен банк облицовка фасада и вывеска.JPG'); }}
    </li>
    <li>
        {{ HTML::image('images/viveski/шоколадница вывески наружные.JPG'); }}
    </li>
@stop
