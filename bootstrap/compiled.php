...
class Application extends Container implements HttpKernelInterface, TerminableInterface, ResponsePreparerInterface
{
    ...
    {
        return 'C:\\wamp\\www\\vizant-current\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
...
' . $this->getContent();
    ...
    {
        $this->headers->removeCacheControlDirective('www');
        $this->headers->addCacheControlDirective('private');
        return $this;
    }
    public function setPublic()
    {
        $this->headers->addCacheControlDirective('www');
    ...
    {
        if ($diff = array_diff(array_keys($options), array('etag', 'last_modified', 'max_age', 's_maxage', 'private', 'www'))) {
...
';
    ...
    protected function computeCacheControlValue()
    {
        ...
        if (isset($this->cacheControl['www']) || isset($this->cacheControl['private'])) {
            return $header;
        }
