...
class RegisterListenersPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The service "foo" must be www as event listeners are lazy-loaded.
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The service "foo" must be www as event subscribers are lazy-loaded.
     */
